 ...
 */
 ...
 $string['pluginname'] = 'Sync Cohort to Multi Courses';
 $string['linkname'] = 'Setup cohort sync for multi courses';
 $string['addpage'] = 'Setup';
 $string['textfields'] = 'Select cohort';
 $string['multi_cohorts_settings'] = 'text-2';
 $string['selectcohort'] = 'Select cohort to sync';
 $string['kies'] = 'Select...';
 $string['selectcourse'] = 'Select courses';
 $string['selectgroup'] = 'Select group';
 $string['nogroup'] = 'No group';
 $string['newgroup'] = 'Make new group';
 $string['submit'] = 'submit';
 $string['cohort'] = 'cohort';
 $string['synchronized'] = 'is synchronized into the courses';
 $string['groupadded'] = 'And the following group is added';
