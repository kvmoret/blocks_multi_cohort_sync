 ...
 */
 ...
 $string['pluginname'] = 'Sitegroep synchroniseren in meerdere cursussen';
 $string['linkname'] = 'Instellingen sync voor meerdere cursussen';
 $string['addpage'] = 'Instellen';
 $string['textfields'] = 'Kies sitegroep';
 $string['multi_cohorts_settings'] = 'text-2';
 $string['selectcohort'] = 'Kies sitegroep om te synchroniseren';
 $string['kies'] = 'Kies...';
 $string['selectcourse'] = 'Kies cursus';
 $string['selectgroup'] = 'Kies groep';
 $string['newgroup'] = 'Maak nieuwe groep';
 $string['nogroup'] = 'Geen groep';
 $string['submit'] = 'Bevestig';
